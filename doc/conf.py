...
latex_documents = [
  ('index', 'Vireo.tex', u'Vireo Documentation',
...
man_pages = [
    ('index', 'Vireo', u'Vireo Documentation',
     [u'Yuanhua Huang'], 1)
]
...
texinfo_documents = [
  ('index', 'Vireo', u'Vireo Documentation',
   u'Yuanhua Huang', 'Vireo', 'One line description of project.',
   'Miscellaneous'),
]
